...
class EnsembleVertex( graph.Vertex ):
    ...
    def generateDataSpec(self, processor, subvertex, dao):
        ...
        spec.reserveMemRegion(REGIONS.BIAS, size=subvertex.n_neurons*4)
        spec.reserveMemRegion(REGIONS.ENCODERS, size=subvertex.n_neurons*self.data.D_in*4)
        spec.reserveMemRegion(REGIONS.DECODERS, size=subvertex.n_neurons*self.data.D_out*4)
