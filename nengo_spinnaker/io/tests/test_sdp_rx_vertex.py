...
def test_sdp_rx_system_region():
    ...
    sr_data = np.frombuffer(region.create_subregion(slice(5, 6), 1).data,
                            dtype=np.uint32).tolist()
