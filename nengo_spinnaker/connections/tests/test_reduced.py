...
class TestOutgoingReducedConnection(object):
    def test_eq(self):
        ...
        rcs = [
            ...
            OutgoingReducedConnection(3, np.eye(3), None, mock.Mock()),
            OutgoingReducedEnsembleConnection(3, np.eye(3), None),
        ]
    ...
    def test_copy(self):
        ...
        c = OutgoingReducedConnection(3, np.eye(3), lambda x: x**2,
                                      mock.Mock())
        d = copy.copy(c)
...
class TestOutgoingReducedEnsembleConnection(object):
    def test_eq_no_func_equiv(self):
        ...
        rcs = [
            OutgoingReducedEnsembleConnection(3, np.eye(3), None, None,
                                              eval_points),
            OutgoingReducedEnsembleConnection(3, np.eye(3), None, None,
                                              eval_points),
            OutgoingReducedEnsembleConnection(3, np.eye(3), None, None, None),
            OutgoingReducedEnsembleConnection(3, np.eye(3), None, None,
                                              eval_points, mock.Mock()),
            OutgoingReducedConnection(3, np.eye(3), None, None),
        ]
    ...
    def test_eq(self):
        ...
        eval_points = np.linspace(-1., 1.)
        rcs = [
            OutgoingReducedEnsembleConnection(1, 1., lambda x: x**2, None,
                                              eval_points),
            OutgoingReducedEnsembleConnection(1, 1., lambda x: x**2, None,
                                              eval_points),
            OutgoingReducedEnsembleConnection(1, 1., lambda x: x**3, None,
                                              eval_points),
        ]
    ...
    def test_copy(self):
        ...
        rcs = OutgoingReducedEnsembleConnection(
            1, 2., lambda x: x**2, keyspace=ks, eval_points=eval_points,
            solver=solver,
    ...
    def test_eq_learning_rules(self):
        ...
        rcs = [
            OutgoingReducedEnsembleConnection(
                1, 1., None, transmitter_learning_rule=lrule),
            OutgoingReducedEnsembleConnection(
                1, 1., None, transmitter_learning_rule=lrule),
            OutgoingReducedEnsembleConnection(1, 1., None)
        ]
...
class TestIncomingReducedConnection(object):
    ...
    def test_copy(self):
        ...
        assert irc.target == new_irc.target
        assert irc.target is not new_irc.target

        assert irc.filter_object == new_irc.filter_object
        assert irc.filter_object is not new_irc.filter_object
